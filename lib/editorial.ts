...
export const CURRENT_ISSUE: EditorialIssue = {
  ...
  dek: "파페치·네타포르테·W컨셉을 가로질러 에디터와 AI가 함께 고른 52 pieces.",
  date: "04 · 24 · 26",
  city: "SEOUL",
  coverLabel: "COVER 01",
  ...
  sections: [
    ...
    },
    {
      ...
      subtitle: "겨울이 가기 전 마지막 캐시미어 코트",
      source: { type: "theme", query: "캐시미어 코트", size: 6 },
      size: 6,
    },
    {
      id: "brand-hermes",
    ...
    },
    {
      ...
      subtitle: "부드럽지만 확실한 존재감",
      source: { type: "theme", query: "니트", size: 6 },
      size: 6,
    },
  ],
};
